...
public class SplashJProgressBar extends javax.swing.JWindow {
    ...
    private void criandoComponentes() {
         ...
         * jLabelSplashImage
         */
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("images.gif"));
    ...
    public static void main(String args[]) {
        ...
        SplashJProgressBar splashScreen = new SplashJProgressBar();
        /**
        ...
        for (int j = 1; j <= 1000; j++) {
            ...
            if (j == (1000 / i)) {
                ...
                jLabelTextoDinamicoPlugins.setText("Carregando: " + i);
                i--;
                try {
                    Thread.sleep(400);
